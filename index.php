        ...
        <div class="row">
            <div class="col-lg-8 bkg-hero-content">
                <h1 class="bkg-hero-title">
                    Discover Rwanda's<br>best stays, cars & experiences
                </h1>
                <p class="bkg-hero-subtitle">
                    From gorilla trekking to luxury lodges, find your perfect Rwandan adventure
                </p>
                
                <div class="bkg-hero-stats">
                    <div class="bkg-hero-stat">
                        <i class="bi bi-building"></i>
                        <span><strong><?php echo number_format($totalStays); ?></strong> stays</span>
                    </div>
                    <div class="bkg-hero-stat">
                        <i class="bi bi-car-front"></i>
                        <span><strong><?php echo number_format($totalCars); ?></strong> cars</span>
                    </div>
                    <div class="bkg-hero-stat">
                        <i class="bi bi-ticket-perforated"></i>
                        <span><strong><?php echo number_format($totalExperiences); ?></strong> experiences</span>
                    </div>
                    <div class="bkg-hero-stat">
                        <i class="bi bi-shop"></i>
                        <span><strong><?php echo number_format($totalRestaurants); ?></strong> restaurants</span>
                    </div>
                </div>
...
<section class="container mb-5">
    <div class="bkg-section-header">
        <div>
            <h2 class="bkg-section-title">Popular destinations in Rwanda</h2>
            <p class="bkg-section-subtitle">Most searched locations by travelers</p>
        </div>
    ...
    <div class="bkg-destination-grid">
        ...
        <a href="search.php?location=<?php echo urlencode($dest['name']); ?>" class="bkg-destination-card">
            ...
            <div class="bkg-destination-count"><?php echo $count; ?> listings</div>
        </a>
        <?php endforeach; ?>
    </div>
</section>
...
<section class="container mb-5">
    <div class="bkg-section-header">
        <div>
            <h2 class="bkg-section-title">Homes guests love</h2>
            <p class="bkg-section-subtitle">Discover properties with outstanding reviews</p>
        </div>
        <a href="search.php?type=stays" class="bkg-section-link">
            Browse all stays <i class="bi bi-arrow-right"></i>
        </a>
    </div>
    
    <?php if (empty($featuredStays)): ?>
        <div class="text-center py-5 bg-light rounded">
            <p class="text-secondary">No stays available at the moment</p>
        </div>
    <?php else: ?>
    <div class="bkg-card-grid">
        <?php foreach ($featuredStays as $stay): 
            $reviewLabel = $stay['avg_rating'] ? getReviewLabel($stay['avg_rating']) : ['New', 'bg-secondary'];
        ...
        <a href="stays/detail.php?id=<?php echo $stay['stay_id']; ?>" class="bkg-property-card">
            <div class="bkg-card-image">
                ...
                <span class="bkg-card-badge verified">Verified</span>
                <?php endif; ?>
            ...
            <div class="bkg-card-content">
                ...
                <div class="bkg-property-footer">
                    <div class="bkg-property-rating">
                        <?php if ($stay['review_count'] > 0): ?>
                            ...
                            <div class="bkg-rating-text">
                                ...
                                <div class="bkg-rating-count"><?php echo number_format($stay['review_count']); ?> reviews</div>
                            </div>
                        <?php else: ?>
                    ...
                    <div class="bkg-property-price">
                        <div class="bkg-price-from">from</div>
                        <div class="bkg-price-value"><?php echo formatPrice($stay['min_price']); ?></div>
                        <div class="bkg-price-unit">per night</div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<section class="container mb-5">
    <div class="bkg-section-header">
        <div>
            <h2 class="bkg-section-title">Reliable car rentals</h2>
            <p class="bkg-section-subtitle">Best rates for your Rwandan adventure</p>
        </div>
    ...
    <?php if (empty($featuredCars)): ?>
        <div class="text-center py-5 bg-light rounded">
            <p class="text-secondary">No cars available at the moment</p>
        </div>
    <?php else: ?>
    <div class="bkg-card-grid">
        ...
        <a href="cars/detail.php?id=<?php echo $car['rental_id']; ?>" class="bkg-property-card">
            ...
            <div class="bkg-card-content">
                <div class="bkg-property-type">Car Rental</div>
                ...
                <div class="bkg-property-footer">
                    <div class="bkg-property-rating">
                        <?php if ($car['review_count'] > 0): ?>
                            ...
                            <div class="bkg-rating-text">
                                ...
                                <div class="bkg-rating-count"><?php echo number_format($car['review_count']); ?> reviews</div>
                            </div>
                        <?php else: ?>
                            <span class="text-muted" style="font-size: 11px;">New</span>
                        <?php endif; ?>
                    ...
                    <div class="bkg-property-price">
                        ...
                        <div class="bkg-price-unit">per day</div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<section class="container mb-5">
    <div class="bkg-section-header">
        <div>
            <h2 class="bkg-section-title">Unforgettable experiences</h2>
            <p class="bkg-section-subtitle">Top-rated activities loved by travelers</p>
        </div>
        <a href="search.php?type=attractions" class="bkg-section-link">
            Browse all experiences <i class="bi bi-arrow-right"></i>
        </a>
    </div>
    
    <?php if (empty($featuredAttractions)): ?>
        <div class="text-center py-5 bg-light rounded">
            <p class="text-secondary">No experiences available at the moment</p>
        </div>
    <?php else: ?>
    <div class="bkg-card-grid">
        ...
        <a href="attractions/detail.php?id=<?php echo $attraction['attraction_id']; ?>" class="bkg-property-card">
            ...
            <div class="bkg-card-content">
                <div class="bkg-property-type"><?php echo sanitize($attraction['category_name'] ?? 'Experience'); ?></div>
                ...
                <div class="bkg-property-footer">
                    <div class="bkg-property-rating">
                        <?php if ($attraction['review_count'] > 0): ?>
                            ...
                            <div class="bkg-rating-text">
                                ...
                                <div class="bkg-rating-count"><?php echo number_format($attraction['review_count']); ?> reviews</div>
                            </div>
                        <?php else: ?>
                            <span class="text-muted" style="font-size: 11px;">New</span>
                        <?php endif; ?>
                    ...
                    <div class="bkg-property-price">
                        ...
                        <div class="bkg-price-unit">per person</div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<section class="container mb-5">
    <div class="bkg-section-header">
        <div>
            <h2 class="bkg-section-title">Special offers & deals</h2>
            <p class="bkg-section-subtitle">Save big on your next stay in Rwanda</p>
        </div>
...
<section class="container mb-5">
    <div class="bkg-features">
        <div class="bkg-section-header text-center mb-4">
            <div>
                <h2 class="bkg-section-title">Why book with GoRwanda+?</h2>
                <p class="bkg-section-subtitle">We're here to make your travel experience seamless</p>
            </div>
        </div>
        ...
        <div class="bkg-features-grid">
            <div class="bkg-feature">
                ...
                <h4 class="bkg-feature-title">Secure booking</h4>
                <p class="bkg-feature-text">Your payment info is encrypted and protected</p>
            </div>
            ...
            <div class="bkg-feature">
                ...
                <h4 class="bkg-feature-title">Best price guarantee</h4>
                <p class="bkg-feature-text">Found a better price? We'll match it</p>
            </div>
            ...
            <div class="bkg-feature">
                ...
                <h4 class="bkg-feature-title">24/7 support</h4>
                <p class="bkg-feature-text">We're here to help, day or night</p>
            </div>
            ...
            <div class="bkg-feature">
                ...
                <h4 class="bkg-feature-title">Verified reviews</h4>
                <p class="bkg-feature-text">Real guests, real experiences</p>
            </div>
        </div>
    </div>
</section>
