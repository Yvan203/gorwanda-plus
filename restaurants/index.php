...
<div class="container">
    ...
    <div class="quick-search">
        <h2 class="quick-search-title">Find a table</h2>
        <form action="" method="GET" class="quick-search-form">
            <div class="quick-search-field">
                <input type="text" name="location" class="quick-search-input" 
                       placeholder="Destination or restaurant name" value="<?php echo sanitize($location); ?>">
            </div>
            <div class="quick-search-field">
            ...
            <div class="quick-search-field">
                <select name="time" class="quick-search-select">
                    ...
                    <option value="18:00" <?php echo $time == '18:00' ? 'selected' : ''; ?>>6:00 PM</option>
                    <option value="19:00" <?php echo $time == '19:00' ? 'selected' : ''; ?>>7:00 PM</option>
                    <option value="20:00" <?php echo $time == '20:00' ? 'selected' : ''; ?>>8:00 PM</option>
                </select>
            </div>
            <div class="quick-search-field">
